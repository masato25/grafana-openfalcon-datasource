System.register(['test/lib/common', 'test/specs/helpers', "../datasource"], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            common_1.describe('openfalconDatasource', function () {
                ...
                common_1.beforeEach(function () {
                    ctx.ds = ctx.$injector.instantiate(datasource_1.OpenfalconDatasource, { instanceSettings: instanceSettings });
                });
                ...
                common_1.describe('building openfalcon params', function () {
